    ...
    return (
        <>
            <div className="CMP-DIV">
                ...
                <form className="MAIL-FRM">
                    <input type="email" placeholder="To" className="IPE" value={to} onChange={(e)=>dispatch(setTo(e.target.value))} />
                    <input type="text" placeholder="Subject" className="IPE" value={subject} onChange={(e)=>dispatch(setSubject(e.target.value))} />
